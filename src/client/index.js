...
.cg-context-anchor{display:inline-flex;align-items:center;flex:0 0 auto;min-width:0}.cg-context-button{display:inline-flex;align-items:center;gap:4px;min-width:0;max-width:220px;height:28px;margin:0;padding:0 4px 0 8px;border:0;border-radius:24px;outline:none;background:transparent;color:var(--dsw-alias-label-secondary,#52525b);font-family:var(--dsw-font-family,Inter,ui-sans-serif,system-ui,sans-serif);font-size:13px;font-weight:500;line-height:20px;cursor:pointer;white-space:nowrap}.cg-context-button:hover,.cg-context-button[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover,#f5f5f5)}.cg-context-button:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3,#d4d4d8)}.cg-context-button-label{min-width:0;overflow:hidden;text-overflow:ellipsis;font-weight:500}.cg-context-button-chevron{display:inline-flex;flex:0 0 auto;color:var(--dsw-alias-label-caption,#737373);transition:transform .12s}.cg-context-button[aria-expanded=true] .cg-context-button-chevron{transform:rotate(180deg)}.cg-context-menu{position:fixed!important;z-index:50;width:324px!important;min-width:0!important;max-width:calc(100vw - 24px)!important;height:auto!important;max-height:calc(100vh - 24px)!important;overflow:auto!important;padding:12px!important;background:#fff!important;color:#1f2937!important;border:1px solid #e5e7eb!important;border-radius:14px!important;box-shadow:0 12px 30px rgb(15 23 42 / 14%)!important;font:13px/1.4 Inter,ui-sans-serif,system-ui,sans-serif!important}.cg-context-menu label{display:block!important;margin:0 0 5px!important;font-size:12px!important;font-weight:500!important;line-height:17px!important;color:#6b7280!important}.cg-context-menu select,.cg-context-menu textarea{box-sizing:border-box!important;width:100%!important;margin:0!important;border:1px solid #d1d5db!important;border-radius:8px!important;background:#fff!important;color:#1f2937!important;padding:8px 9px!important;font:13px/1.4 Inter,ui-sans-serif,system-ui,sans-serif!important;outline:none!important}.cg-context-menu select{display:block!important;height:36px!important;min-height:36px!important}.cg-context-menu textarea{display:block!important;height:96px!important;min-height:96px!important;max-height:144px!important;resize:vertical!important;line-height:1.5!important}.cg-context-menu select:focus,.cg-context-menu textarea:focus{border-color:#60a5fa!important;box-shadow:0 0 0 3px #dbeafe!important}.cg-context-target{display:flex!important;align-items:center!important;min-height:28px!important;margin:10px 0 12px!important;padding:5px 8px!important;border-radius:8px!important;background:#f8fafc!important;color:#64748b!important;font-size:12px!important;line-height:18px!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}.cg-context-menu button{display:inline-flex!important;align-items:center!important;justify-content:center!important;height:32px!important;margin:10px 0 0!important;border:0!important;border-radius:8px!important;padding:7px 10px!important;background:#2563eb!important;color:#fff!important;font:500 13px/18px Inter,ui-sans-serif,system-ui,sans-serif!important;cursor:pointer!important}.cg-context-menu button:hover{background:#1d4ed8!important}
...
function ContextCommand({ sessionId, projectPath, inputActions, targetStore, sendPrompt }) {
  ...
  return h('span', { ref: anchorRef, className: 'cg-context-anchor' },
    h('button', { ref: buttonRef, type: 'button', className: 'cg-context-button', title: '上下文任务', 'aria-label': '打开上下文任务', 'aria-haspopup': 'dialog', 'aria-expanded': open, onClick: () => { setTaskMessage(''); setTaskFailed(false); setOpen(value => !value); } },
      h('span', { className: 'cg-context-button-label' }, '上下文'),
      h('svg', { width: 14, height: 14, className: 'cg-context-button-chevron', viewBox: '0 0 14 14', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', 'aria-hidden': true },
